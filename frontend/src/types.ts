/**
 * Frontend types for three-man-league
 *
 * Re-exports all shared types from @shared/types and adds frontend-specific type aliases.
...
export type { PickPosition } from "@shared/types";
